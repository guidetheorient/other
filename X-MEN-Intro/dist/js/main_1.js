...
module.exports = __webpack_require__.p + "img/envato_pEnZsmR.jpg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_carousel_css__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_goTop_css__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_goTop_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_goTop_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_waterfall_css__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_waterfall_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__css_waterfall_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_font_awesome_4_7_0_css_font_awesome_min_css__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_font_awesome_4_7_0_css_font_awesome_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__css_font_awesome_4_7_0_css_font_awesome_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__index_html__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lib_jquery_3_2_1_min__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lib_jquery_3_2_1_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__lib_jquery_3_2_1_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Carousel__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__GoTop__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Waterfall__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ScrollChangeColor__ = __webpack_require__(31);
...
__WEBPACK_IMPORTED_MODULE_7__Carousel__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_6__lib_jquery_3_2_1_min___default()('.carousel'))
new __WEBPACK_IMPORTED_MODULE_8__GoTop__["a" /* default */]()
__WEBPACK_IMPORTED_MODULE_9__Waterfall__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_6__lib_jquery_3_2_1_min___default()('.waterfall-wrap'))
new __WEBPACK_IMPORTED_MODULE_10__ScrollChangeColor__["a" /* default */]()
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min__);
...
// define(['jquery'],function($){
  // Carousels = (function(){
    ...
    Carousel.prototype.init = function () {
      ...
      //容器宽度为可视区域宽度
      this.$ct.width(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(window).width())
      
      //使图片宽高为浏览器可视区域的宽高，适应屏幕
      var windowWidth = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(window).width()
      $imgCt.find('img').each(function (index,ele) {
        __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(ele).width(windowWidth)
      })

      //使图片水平排列
      var imgWidth = this.imgWidth = windowWidth
      var imgQuanity = this.imgQuanity = $imgCt.find('img').length
      $imgCt.find('img').height(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(window).height())
    ...
    Carousel.prototype.bind = function () {
      ...
      this.$rectIcon.on('click','.rect',function(){
        var interval = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(this).index() - _this.index
        if(interval < 0){
          _this.showBefore(-interval)
        }else if(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(this).index() > _this.index){
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function ($ct) {
    $ct.each(function (index,element) {
      //element是DOM元素
      new Carousel(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(element))
    })
  }
});
...
// define(['jquery'],function ($) {
  function GoTop(){
      this.ct = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()('html,body')
      this.createNode()
      this.target = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()('.go-top')
      this.bindEvent()
    }
...
// define(['jquery'], function($) {
  ...
  Waterfall.prototype.bind = function() {
    ...
    this.$loadMoreButton.on('click', function(event) {
      ...
      if(_this.index >= _this.filmList.length){
        __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(event.target).text('Finised').addClass('active')
      }
      _this.renderNews()
    })

    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default.a.get('//oybg5lxuc.bkt.clouddn.com/1.json').then(function(response){
  ...
  Waterfall.prototype.renderNews = function(){
    ...
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default.a.each(films, function(index,ele){
      ...
      $node.find('img').on('load',function(e){
        ...
        var $span = __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(e.target).parent().find('span')
  ...
  Waterfall.prototype.getNewsViaAjax = function(callback) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default.a.get('//oybg5lxuc.bkt.clouddn.com/1.json', {
      index: _this.index,
      length: 4
  ...
  Waterfall.prototype.generateNewsDOM = function(ele) {
    ...
    html = '<li class="item">' +
      ...
      '</li>';
    return __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(html)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function($ct) {
    $ct.each(function(index, element) {
      //element是DOM元素
      new Waterfall(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(element))
    })
  }
});
...
// define(['jquery'],function ($) {
    ...
    ScrollChangeColor.prototype.bind = function () {
        __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(document).on('scroll',function () {
            if(__WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()(document).scrollTop() != 0){
                __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()('#header').css({'background':'rgb(21,21,21)'})
            } else {
                __WEBPACK_IMPORTED_MODULE_0__lib_jquery_3_2_1_min___default()('#header').css({'background':'rgba(21,21,21,0)'})
            }
        })
    }
...
/* harmony default export */ __webpack_exports__["a"] = (ScrollChangeColor);
